...
from asone.trackers.strong_sort.tracker.deep.models import build_model
from asone.trackers.strong_sort.tracker.deep.reid_model_factory import (
    get_model_name,
    get_model_url,
...
class ReIDDetectMultiBackend(nn.Module):
    ...
    def __init__(self, weights="osnet_x0_25_msmt17.pt", device=torch.device("cpu"), fp16=False):
        ...
        self.model = build_model('osnet_x0_25', num_classes=1, pretrained=True, use_gpu=device)
