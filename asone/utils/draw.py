...
def draw_masks(image, bbox_xyxy, class_ids, mask_alpha=0.3, mask_maps=None):
    mask_img = image.copy()

    # Draw bounding boxes and labels of detections
    for i, (box, class_id) in enumerate(zip(bbox_xyxy, class_ids)):
...
def draw_detections_and_masks(image, boxes, class_ids, scores, mask_alpha=0.3, mask_maps=None):
