...
def setup_package():
    setup(
        ...
        packages=[DISTNAME,
                    ...
                    f'{DISTNAME}.detectors.yolov5.models',
                    f'{DISTNAME}.detectors.yolov5.utils',
                    f'{DISTNAME}.detectors.yolov6',
                    f'{DISTNAME}.detectors.yolov6.layers',
                    f'{DISTNAME}.detectors.yolov6.models',
                    f'{DISTNAME}.detectors.yolov6.utils',
                    f'{DISTNAME}.detectors.yolov7',
                    f'{DISTNAME}.detectors.yolov7.models',
                    f'{DISTNAME}.detectors.yolov7.utils',
